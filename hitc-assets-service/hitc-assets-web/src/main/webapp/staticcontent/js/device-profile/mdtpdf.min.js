(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/javascripts/export/fingerprint.js":[function(require,module,exports){
var fingerprint=require("./../modules/fingerprint.js");fingerprint();
},{"./../modules/fingerprint.js":"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/javascripts/modules/fingerprint.js"}],"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/javascripts/modules/GOVUK_helpers.js":[function(require,module,exports){
module.exports={expires:"",cookieDomain:"",setCookie:function(e,i,o,t){if(t&&(this.cookieDomain="; domain="+t),o){var n=new Date;n.setTime(n.getTime()+24*o*60*60*1e3),this.expires="; expires="+n.toGMTString()}document.cookie=e+"="+i+this.expires+this.cookieDomain+"; path=/"},getCookie:function(e){var i,o,t=e+"=",n=document.cookie.split(";");for(i=0;i<n.length;i+=1){for(o=n[i];" "===o.charAt(0);)o=o.substring(1,o.length);if(0===o.indexOf(t))return o.substring(t.length,o.length)}return null},eraseCookie:function(e){this.setCookie(e,"",-1)}};
},{}],"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/javascripts/modules/fingerprint.js":[function(require,module,exports){
var Mdtpdf=require("mdtpdf"),base64=require("base64").Base64,govuk=require("./GOVUK_helpers.js");module.exports=function(){var e,o,t=new Mdtpdf({screen_resolution:!0,ie_activex:!0}),i=govuk.getCookie("mdtpdf"),s=base64.btoa(t.get());!i&&s&&(e=window.location.hostname.split(".").slice(-3),o=e.length>1?"."+e.join("."):window.location.hostname,govuk.setCookie("mdtpdf",s,7300,o))};
},{"./GOVUK_helpers.js":"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/javascripts/modules/GOVUK_helpers.js","base64":"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/js-base64/base64.js","mdtpdf":"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/javascripts/modules/mdtpdf.js"}],"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/javascripts/modules/mdtpdf.js":[function(require,module,exports){
(function (global){
require("/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/json3/lib/json3.js");var __browserify_shim_require__=require;(function(e,t,n){!function(t){"use strict";var n=function(e){var t,n;t=Array.prototype.forEach,n=Array.prototype.map,this.each=function(e,n,r){if(null!==e)if(t&&e.forEach===t)e.forEach(n,r);else if(e.length===+e.length){for(var i=0,a=e.length;a>i;i++)if(n.call(r,e[i],i,e)==={})return}else for(var o in e)if(e.hasOwnProperty(o)&&n.call(r,e[o],o,e)==={})return},this.map=function(e,t,r){var i=[];return null==e?i:n&&e.map===n?e.map(t,r):(this.each(e,function(e,n,a){i[i.length]=t.call(r,e,n,a)}),i)},"object"==typeof e?(this.debug=e.debug,this.hasher=e.hasher,this.openDB=e.openDB,this.addBehavior=e.addBehavior,this.screen_resolution=e.screen_resolution,this.canvas=e.canvas,this.ie_activex=e.ie_activex):"function"==typeof e&&(this.hasher=e)};n.prototype={get:function(){var e={};if(e.userAgent=navigator.userAgent,e.language=navigator.language,e.colorDepth=screen.colorDepth,this.screen_resolution){var t=this.getScreenResolution();"undefined"!=typeof t&&(e.resolution=this.getScreenResolution().join("x"))}return e.timezone=(new Date).getTimezoneOffset(),e.clientSideTimestamp=(new Date).getTime(),e.sessionStorage=this.hasSessionStorage(),e.localStorage=this.hasLocalStorage(),e.indexedDB=!!window.indexedDB,this.addBehavior&&(e.addBehavior=typeof document.body.addBehavior),this.openDB&&(e.openDatabase=typeof window.openDatabase),e.cpuClass=navigator.cpuClass,e.platform=navigator.platform,e.doNotTrack=!!navigator.doNotTrack,e.numberOfPlugins=navigator.plugins.length,e.plugins=this.getPluginsString(),this.canvas&&this.isCanvasSupported()&&(e.canvas=this.getCanvasFingerprint()),this.debug?e:this.hasher?"string"==typeof this.hasher?this.hasher(e.join("###"),31):this.murmurhash3_32_gc(e.join("###"),31):JSON.stringify(e)},murmurhash3_32_gc:function(e,t){var n,r,i,a,o,s,l,c;for(n=3&e.length,r=e.length-n,i=t,o=3432918353,s=461845907,c=0;r>c;)l=255&e.charCodeAt(c)|(255&e.charCodeAt(++c))<<8|(255&e.charCodeAt(++c))<<16|(255&e.charCodeAt(++c))<<24,++c,l=(65535&l)*o+(((l>>>16)*o&65535)<<16)&4294967295,l=l<<15|l>>>17,l=(65535&l)*s+(((l>>>16)*s&65535)<<16)&4294967295,i^=l,i=i<<13|i>>>19,a=5*(65535&i)+((5*(i>>>16)&65535)<<16)&4294967295,i=(65535&a)+27492+(((a>>>16)+58964&65535)<<16);switch(l=0,n){case 3:l^=(255&e.charCodeAt(c+2))<<16;case 2:l^=(255&e.charCodeAt(c+1))<<8;case 1:l^=255&e.charCodeAt(c),l=(65535&l)*o+(((l>>>16)*o&65535)<<16)&4294967295,l=l<<15|l>>>17,l=(65535&l)*s+(((l>>>16)*s&65535)<<16)&4294967295,i^=l}return i^=e.length,i^=i>>>16,i=2246822507*(65535&i)+((2246822507*(i>>>16)&65535)<<16)&4294967295,i^=i>>>13,i=3266489909*(65535&i)+((3266489909*(i>>>16)&65535)<<16)&4294967295,i^=i>>>16,i>>>0},hasLocalStorage:function(){try{return!!t.localStorage}catch(e){return!0}},hasSessionStorage:function(){try{return!!t.sessionStorage}catch(e){return!0}},isCanvasSupported:function(){var e=document.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))},isIE:function(){return"Microsoft Internet Explorer"===navigator.appName?!0:"Netscape"===navigator.appName&&/Trident/.test(navigator.userAgent)?!0:!1},getPluginsString:function(){return this.isIE()?this.getIEPluginsString():this.getRegularPluginsString()},getRegularPluginsString:function(){return this.map(navigator.plugins,function(e){this.map(e,function(e){return[e.type,e.suffixes].join("~")}).join(",");return e.name},this)},getIEPluginsString:function(){var e=["ShockwaveFlash.ShockwaveFlash","AcroPDF.PDF","PDF.PdfCtrl","QuickTime.QuickTime","rmocx.RealPlayer G2 Control","rmocx.RealPlayer G2 Control.1","RealPlayer.RealPlayer(tm) ActiveX Control (32-bit)","RealVideo.RealVideo(tm) ActiveX Control (32-bit)","RealPlayer","SWCtl.SWCtl","WMPlayer.OCX","AgControl.AgControl","Skype.Detection"];return this.ie_activex&&t.ActiveXObject?this.map(e,function(e){try{return new ActiveXObject(e),e}catch(t){return null}}).join(";"):""},getScreenResolution:function(){return[screen.height,screen.width]},getCanvasFingerprint:function(){var e=document.createElement("canvas"),t=e.getContext("2d"),n="http://valve.github.io";t.textBaseline="top",t.font="14px 'Arial'",t.textBaseline="alphabetic",t.fillStyle="#f60",t.fillRect(125,1,62,20),t.fillStyle="#069",t.fillText(n,2,15),t.fillStyle="rgba(102, 204, 0, 0.7)",t.fillText(n,4,17);var r=e.toDataURL();return r.substr(r.indexOf(",")+1)}},"object"==typeof e&&"object"==typeof exports&&(e.exports=n),t.Mdtpdf=n}(window)}).call(global,module,void 0,void 0);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/json3/lib/json3.js":"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/json3/lib/json3.js"}],"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/grunt-browserify/node_modules/browserify/node_modules/buffer/index.js":[function(require,module,exports){
...
},{"base64-js":"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/grunt-browserify/node_modules/browserify/node_modules/buffer/node_modules/base64-js/lib/b64.js","ieee754":"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/grunt-browserify/node_modules/browserify/node_modules/buffer/node_modules/ieee754/index.js","is-array":"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/grunt-browserify/node_modules/browserify/node_modules/buffer/node_modules/is-array/index.js"}],"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/grunt-browserify/node_modules/browserify/node_modules/buffer/node_modules/base64-js/lib/b64.js":[function(require,module,exports){
...
},{}],"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/grunt-browserify/node_modules/browserify/node_modules/buffer/node_modules/ieee754/index.js":[function(require,module,exports){
...
},{}],"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/grunt-browserify/node_modules/browserify/node_modules/buffer/node_modules/is-array/index.js":[function(require,module,exports){
...
},{}],"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/js-base64/base64.js":[function(require,module,exports){
...
},{"buffer":"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/grunt-browserify/node_modules/browserify/node_modules/buffer/index.js"}],"/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/node_modules/json3/lib/json3.js":[function(require,module,exports){
(function (global){
var __browserify_shim_require__=require;(function(t,e,r,n,o){(function(){function r(t,e){function n(t){if(n[t]!==d)return n[t];var r;if("bug-string-char-index"==t)r="a"!="a"[0];else if("json"==t)r=n("json-stringify")&&n("json-parse");else{var i,a='{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}';if("json-stringify"==t){var l=e.stringify,u="function"==typeof l&&C;if(u){(i=function(){return 1}).toJSON=i;try{u="0"===l(0)&&"0"===l(new o)&&'""'==l(new c)&&l(v)===d&&l(d)===d&&l()===d&&"1"===l(i)&&"[1]"==l([i])&&"[null]"==l([d])&&"null"==l(null)&&"[null,null,null]"==l([d,v,null])&&l({a:[i,!0,!1,null,"\x00\b\n\f\r	"]})==a&&"1"===l(null,i)&&"[\n 1,\n 2\n]"==l([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==l(new f(-864e13))&&'"+275760-09-13T00:00:00.000Z"'==l(new f(864e13))&&'"-000001-01-01T00:00:00.000Z"'==l(new f(-621987552e5))&&'"1969-12-31T23:59:59.999Z"'==l(new f(-1))}catch(s){u=!1}}r=u}if("json-parse"==t){var h=e.parse;if("function"==typeof h)try{if(0===h("0")&&!h(!1)){i=h(a);var p=5==i.a.length&&1===i.a[0];if(p){try{p=!h('"	"')}catch(s){}if(p)try{p=1!==h("01")}catch(s){}if(p)try{p=1!==h("1.")}catch(s){}}}}catch(s){p=!1}r=p}}return n[t]=!!r}t||(t=a.Object()),e||(e=a.Object());var o=t.Number||a.Number,c=t.String||a.String,l=t.Object||a.Object,f=t.Date||a.Date,u=t.SyntaxError||a.SyntaxError,s=t.TypeError||a.TypeError,h=t.Math||a.Math,p=t.JSON||a.JSON;"object"==typeof p&&p&&(e.stringify=p.stringify,e.parse=p.parse);var g,y,d,b=l.prototype,v=b.toString,C=new f(-0xc782b5b800cec);try{C=-109252==C.getUTCFullYear()&&0===C.getUTCMonth()&&1===C.getUTCDate()&&10==C.getUTCHours()&&37==C.getUTCMinutes()&&6==C.getUTCSeconds()&&708==C.getUTCMilliseconds()}catch(S){}if(!n("json")){var j="[object Function]",O="[object Date]",w="[object Number]",_="[object String]",T="[object Array]",A="[object Boolean]",N=n("bug-string-char-index");if(!C)var J=h.floor,U=[0,31,59,90,120,151,181,212,243,273,304,334],x=function(t,e){return U[e]+365*(t-1970)+J((t-1969+(e=+(e>1)))/4)-J((t-1901+e)/100)+J((t-1601+e)/400)};if((g=b.hasOwnProperty)||(g=function(t){var e,r={};return(r.__proto__=null,r.__proto__={toString:1},r).toString!=v?g=function(t){var e=this.__proto__,r=t in(this.__proto__=null,this);return this.__proto__=e,r}:(e=r.constructor,g=function(t){var r=(this.constructor||e).prototype;return t in this&&!(t in r&&this[t]===r[t])}),r=null,g.call(this,t)}),y=function(t,e){var r,n,o,c=0;(r=function(){this.valueOf=0}).prototype.valueOf=0,n=new r;for(o in n)g.call(n,o)&&c++;return r=n=null,c?y=2==c?function(t,e){var r,n={},o=v.call(t)==j;for(r in t)o&&"prototype"==r||g.call(n,r)||!(n[r]=1)||!g.call(t,r)||e(r)}:function(t,e){var r,n,o=v.call(t)==j;for(r in t)o&&"prototype"==r||!g.call(t,r)||(n="constructor"===r)||e(r);(n||g.call(t,r="constructor"))&&e(r)}:(n=["valueOf","toString","toLocaleString","propertyIsEnumerable","isPrototypeOf","hasOwnProperty","constructor"],y=function(t,e){var r,o,c=v.call(t)==j,a=!c&&"function"!=typeof t.constructor&&i[typeof t.hasOwnProperty]&&t.hasOwnProperty||g;for(r in t)c&&"prototype"==r||!a.call(t,r)||e(r);for(o=n.length;r=n[--o];a.call(t,r)&&e(r));}),y(t,e)},!n("json-stringify")){var m={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},M="000000",k=function(t,e){return(M+(e||0)).slice(-t)},D="\\u00",E=function(t){for(var e='"',r=0,n=t.length,o=!N||n>10,i=o&&(N?t.split(""):t);n>r;r++){var c=t.charCodeAt(r);switch(c){case 8:case 9:case 10:case 12:case 13:case 34:case 92:e+=m[c];break;default:if(32>c){e+=D+k(2,c.toString(16));break}e+=o?i[r]:t.charAt(r)}}return e+'"'},P=function(t,e,r,n,o,i,c){var a,l,f,u,h,p,b,C,S,j,N,U,m,M,D,Z;try{a=e[t]}catch(F){}if("object"==typeof a&&a)if(l=v.call(a),l!=O||g.call(a,"toJSON"))"function"==typeof a.toJSON&&(l!=w&&l!=_&&l!=T||g.call(a,"toJSON"))&&(a=a.toJSON(t));else if(a>-1/0&&1/0>a){if(x){for(h=J(a/864e5),f=J(h/365.2425)+1970-1;x(f+1,0)<=h;f++);for(u=J((h-x(f,0))/30.42);x(f,u+1)<=h;u++);h=1+h-x(f,u),p=(a%864e5+864e5)%864e5,b=J(p/36e5)%24,C=J(p/6e4)%60,S=J(p/1e3)%60,j=p%1e3}else f=a.getUTCFullYear(),u=a.getUTCMonth(),h=a.getUTCDate(),b=a.getUTCHours(),C=a.getUTCMinutes(),S=a.getUTCSeconds(),j=a.getUTCMilliseconds();a=(0>=f||f>=1e4?(0>f?"-":"+")+k(6,0>f?-f:f):k(4,f))+"-"+k(2,u+1)+"-"+k(2,h)+"T"+k(2,b)+":"+k(2,C)+":"+k(2,S)+"."+k(3,j)+"Z"}else a=null;if(r&&(a=r.call(e,t,a)),null===a)return"null";if(l=v.call(a),l==A)return""+a;if(l==w)return a>-1/0&&1/0>a?""+a:"null";if(l==_)return E(""+a);if("object"==typeof a){for(M=c.length;M--;)if(c[M]===a)throw s();if(c.push(a),N=[],D=i,i+=o,l==T){for(m=0,M=a.length;M>m;m++)U=P(m,a,r,n,o,i,c),N.push(U===d?"null":U);Z=N.length?o?"[\n"+i+N.join(",\n"+i)+"\n"+D+"]":"["+N.join(",")+"]":"[]"}else y(n||a,function(t){var e=P(t,a,r,n,o,i,c);e!==d&&N.push(E(t)+":"+(o?" ":"")+e)}),Z=N.length?o?"{\n"+i+N.join(",\n"+i)+"\n"+D+"}":"{"+N.join(",")+"}":"{}";return c.pop(),Z}};e.stringify=function(t,e,r){var n,o,c,a;if(i[typeof e]&&e)if((a=v.call(e))==j)o=e;else if(a==T){c={};for(var l,f=0,u=e.length;u>f;l=e[f++],a=v.call(l),(a==_||a==w)&&(c[l]=1));}if(r)if((a=v.call(r))==w){if((r-=r%1)>0)for(n="",r>10&&(r=10);n.length<r;n+=" ");}else a==_&&(n=r.length<=10?r:r.slice(0,10));return P("",(l={},l[""]=t,l),o,c,n,"",[])}}if(!n("json-parse")){var Z,F,$=c.fromCharCode,q={92:"\\",34:'"',47:"/",98:"\b",116:"	",110:"\n",102:"\f",114:"\r"},H=function(){throw Z=F=null,u()},I=function(){for(var t,e,r,n,o,i=F,c=i.length;c>Z;)switch(o=i.charCodeAt(Z)){case 9:case 10:case 13:case 32:Z++;break;case 123:case 125:case 91:case 93:case 58:case 44:return t=N?i.charAt(Z):i[Z],Z++,t;case 34:for(t="@",Z++;c>Z;)if(o=i.charCodeAt(Z),32>o)H();else if(92==o)switch(o=i.charCodeAt(++Z)){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:t+=q[o],Z++;break;case 117:for(e=++Z,r=Z+4;r>Z;Z++)o=i.charCodeAt(Z),o>=48&&57>=o||o>=97&&102>=o||o>=65&&70>=o||H();t+=$("0x"+i.slice(e,Z));break;default:H()}else{if(34==o)break;for(o=i.charCodeAt(Z),e=Z;o>=32&&92!=o&&34!=o;)o=i.charCodeAt(++Z);t+=i.slice(e,Z)}if(34==i.charCodeAt(Z))return Z++,t;H();default:if(e=Z,45==o&&(n=!0,o=i.charCodeAt(++Z)),o>=48&&57>=o){for(48==o&&(o=i.charCodeAt(Z+1),o>=48&&57>=o)&&H(),n=!1;c>Z&&(o=i.charCodeAt(Z),o>=48&&57>=o);Z++);if(46==i.charCodeAt(Z)){for(r=++Z;c>r&&(o=i.charCodeAt(r),o>=48&&57>=o);r++);r==Z&&H(),Z=r}if(o=i.charCodeAt(Z),101==o||69==o){for(o=i.charCodeAt(++Z),(43==o||45==o)&&Z++,r=Z;c>r&&(o=i.charCodeAt(r),o>=48&&57>=o);r++);r==Z&&H(),Z=r}return+i.slice(e,Z)}if(n&&H(),"true"==i.slice(Z,Z+4))return Z+=4,!0;if("false"==i.slice(Z,Z+5))return Z+=5,!1;if("null"==i.slice(Z,Z+4))return Z+=4,null;H()}return"$"},Y=function(t){var e,r;if("$"==t&&H(),"string"==typeof t){if("@"==(N?t.charAt(0):t[0]))return t.slice(1);if("["==t){for(e=[];t=I(),"]"!=t;r||(r=!0))r&&(","==t?(t=I(),"]"==t&&H()):H()),","==t&&H(),e.push(Y(t));return e}if("{"==t){for(e={};t=I(),"}"!=t;r||(r=!0))r&&(","==t?(t=I(),"}"==t&&H()):H()),(","==t||"string"!=typeof t||"@"!=(N?t.charAt(0):t[0])||":"!=I())&&H(),e[t.slice(1)]=Y(I());return e}H()}return t},B=function(t,e,r){var n=L(t,e,r);n===d?delete t[e]:t[e]=n},L=function(t,e,r){var n,o=t[e];if("object"==typeof o&&o)if(v.call(o)==T)for(n=o.length;n--;)B(o,n,r);else y(o,function(t){B(o,t,r)});return r.call(t,e,o)};e.parse=function(t,e){var r,n;return Z=0,F=""+t,r=Y(I()),"$"!=I()&&H(),Z=F=null,e&&v.call(e)==j?L((n={},n[""]=r,n),"",e):r}}}return e.runInContext=r,e}var o="function"==typeof n&&n.amd,i={"function":!0,object:!0},c=i[typeof e]&&e&&!e.nodeType&&e,a=i[typeof window]&&window||this,l=c&&i[typeof t]&&t&&!t.nodeType&&"object"==typeof global&&global;if(!l||l.global!==l&&l.window!==l&&l.self!==l||(a=l),c&&!o)r(a,c);else{var f=a.JSON,u=a.JSON3,s=!1,h=r(a,a.JSON3={noConflict:function(){return s||(s=!0,a.JSON=f,a.JSON3=u,f=u=null),h}});a.JSON={parse:h.parse,stringify:h.stringify}}o&&n(function(){return h})}).call(this),o("undefined"!=typeof JSON?JSON:window.JSON)}).call(global,void 0,void 0,void 0,void 0,function(t){module.exports=t});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{}]},{},["/var/lib/jenkins/jobs/github.com_assets-frontend/workspace/assets/javascripts/export/fingerprint.js"])